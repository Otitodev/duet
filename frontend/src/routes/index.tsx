...
const initialStickers: Sticker[] = [
  {
    id: 'text-block',
    src: '/stickers/text-block.svg',
    label: 'Text layer sticker',
    rotation: 6,
  ...
  {
    id: 'shapes',
    src: '/stickers/shapes.svg',
    label: 'Shapes sticker',
    rotation: -7,
  ...
  {
    id: 'photo-frame',
    src: '/stickers/photo-frame.svg',
    label: 'Cropped photo sticker',
    rotation: 7,
  ...
  {
    id: 'swatch-stack',
    src: '/stickers/swatch-stack.svg',
    label: 'Colour swatch sticker',
    rotation: -8,
  ...
  {
    id: 'gradient-chip',
    src: '/stickers/gradient-chip.svg',
    label: 'Gradient swatch sticker',
    rotation: 12,
